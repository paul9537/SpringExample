...
<body>
	...
	<%-- 통화 --%>
	통화 : <fmt:formatNumber value="${number }" type="percent" /> <br>
	...
	<h2> Date 포맷 </h2>
	<%-- Date 객체 포맷 --%>
	date format : <fmt:formatDate value="${date }" pattern="yyyy년 MM월 dd일 mm분 ss초" /> <br>
	
	<fmt:formatDate value="${date }" pattern="yyyy/MM/dd HH:mm:ss" var="today" /> <br>
	
	저장된 변수의 데이트포맷 : ${today }
	
	<%-- String을 Date 객체로 변환 2022/02/18 17:26:18 --%>
